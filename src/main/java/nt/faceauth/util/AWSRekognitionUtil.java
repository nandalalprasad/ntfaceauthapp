...
public class AWSRekognitionUtil {
	...
	public void uploadToAmazonS3(String keyName, String uploadFileName) {
		...
		try {
			...
			uploadFileName = "C://Users//Nandalal//Desktop//Amazon WS//Images//"+uploadFileName;
...
*/        	
	 ...
	 */
	public RekognitionResult storeFace(RekognitionResult rekognitionResult, Float matchThreshold, int maxFacesToReturn) {
		
			String sourceImageName = rekognitionResult.getCustomerImageName();
			...
			for (FaceRecord faceRecord : faceRecords) {
				rekognitionResult.setMatchedFace(faceRecord.getFace());
	 ...
	 */
	public RekognitionResult searchFaceAgainstImage(RekognitionResult rekognitionResult, Float matchThreshold, int maxFacesToReturn) {
		ObjectMapper objectMapper = new ObjectMapper();
		
		// Get an image object from S3 bucket for the image input.
		Image image = new Image().withS3Object(new S3Object().withBucket(bucket).withName(rekognitionResult.getCustomerImageName()));
		...
		System.out.println("Faces matching largest face in image from " + rekognitionResult.getCustomerImageName());
	...
	public RekognitionResult searchFaceWithFaceId(String faceId, Float matchThreshold, int maxFacesToReturn) {
        ObjectMapper objectMapper = new ObjectMapper();
